...
<?php include './partials/layouts/layoutTop.php' ?>
        ...
        <div class="dashboard-main-body">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                <h6 class="fw-semibold mb-0">Job Manager</h6>
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">Job Manager</li>
                </ul>
            </div>
...
<tbody>
    <tr>
        ...
        <td>Doctor Interview for MOH <small>Alias : doctor-interview-for-moh-</small></td>
        <td>Healthcare</td>
        <td>31 Jan 2018</td>
    ...
    <td>
        ...
        <td>Staff Nurse <small>Alias : staff-nurse-</small></td>
        <td>Healthcare</td>
        <td>09 Mar 2018</td>
        <td><input type="number" class="form-control" style="width: 60px;"></td>
        <td><span class="text-success">&#10004;</span></td>
    ...
    <td>
        ...
        <td>SPECIALIST /CONSULTANT ICU / ANESTHESIA <small>Alias : specialist-consultant-icu-anesthesia</small></td>
        <td>Healthcare</td>
        <td>02 May 2018</td>
        <td><input type="number" class="form-control" style="width: 60px;"></td>
        <td><span class="text-success">&#10004;</span></td>
    ...
    <td>
        ...
        <td>Dental Asst. Nurse <small>Alias : dental-assistant-nurse-</small></td>
        <td>Healthcare</td>
        <td>04 Oct 2018</td>
        <td><input type="number" class="form-control" style="width: 60px;"></td>
        <td><span class="text-success">&#10004;</span></td>
